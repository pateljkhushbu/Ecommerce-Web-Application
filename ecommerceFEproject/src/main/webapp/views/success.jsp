...
<div class="card bg-dark text-white">
  <img class="card-img" src="<%=request.getContextPath()%>/images/bulb1.jpg" style=" background-size: cover; background-position: center;  height: 700px; width=100%;" alt="Card image">
  <div class="card-img-overlay">
    <p class="card-title" style="font-family: Great Vibes; font-size: 50px">Succesfull</p>
        <a href="${pageContext.request.contextPath}/addprodpage" class="btn btn-primary btn-lg center-block" Style="background-color: #eff1f7; color:black">Manage Product</a>
	</div>
  </div>
</div>
