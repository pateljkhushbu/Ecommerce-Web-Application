...
<div class="card bg-dark text-white">
  <img class="card-img" src="<%=request.getContextPath()%>/images/log3.jpg" style=" background-size: cover; background-position: center;  height: 700px; width=100%; alt="Card image">
  <div class="card-img-overlay">
    <p class="card-title" style="font-family: Great Vibes; font-size: 50px">Want to know about us? then visit us :)</p>
    <p class="card-text" style="font-family: Great Vibes; font-size: 40px">We would gladly provide you Best experience of all. With great quality, quantity and opportunity</p>
    <p class="card-text" style="font-family: Great Vibes; font-size: 40px">Your Trust is our gain which we never intend to fail</p>
        <a href="${pageContext.request.contextPath}/" class="btn btn-primary btn-lg center-block" Style="background-color: #eff1f7; color:black">Go visit us</a>
	</div>
  </div>
</div>
...
</html> <footer class="page-footer bootom-fixed" style="background-color:#045e56; color:black;">
