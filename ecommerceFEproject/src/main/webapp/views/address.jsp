...
<div class="manage" >
<h1>Details :)</h1>
<form method="post" action="${pageContext.request.contextPath}/manageDetails">
		<div class="form-group row">
		<label class="col-lg-3 label">First Name</label>
              <div class="col-lg-8">

		<input type="text" class="form-control" placeholder="First Name" name="dFname" required="true">
		</div>
        </div>
        
        <div class="form-group row">
		<label class="col-lg-3 label">Middle Name</label>
              <div class="col-lg-8">

		<input type="text" class="form-control" placeholder="Middle Name" name="dMname" required="true">
		</div>
        </div>
        
        <div class="form-group row">
		<label class="col-lg-3 label">Last Name</label>
              <div class="col-lg-8">

		<input type="text" class="form-control" placeholder="Last Name" name="dLname" required="true">
		</div>
        </div>
        
        <div class="form-group row">
		<label class="col-lg-3 label">Address Line1</label>
              <div class="col-lg-8">

		<input type="text" class="form-control" placeholder="Address Line1" name="dAdd1" required="true">
        <p class="help-block">Street address, P.O. box, company name, c/o</p>
		</div>
        </div>
        
        <div class="form-group row">
		<label class="col-lg-3 label">Address Line2</label>
              <div class="col-lg-8">

		<input type="text" class="form-control" placeholder="Address Line2" name="dAdd2" required="true">
		...
		<div class="form-group row">
		<label class="col-lg-3 label">City/town</label>
              <div class="col-lg-8">
       <input type="text" id="phoneField" name="dCity" class="form-control phone-field" placeholder="City/Town" required="true">
		</div>
        </div>
		
        <div class="form-group row">
		<label class="col-lg-3 label">State / Province / Region</label>
              <div class="col-lg-8">

 <input id="region" name="dState" type="text" placeholder="state / province / region"
                        class="form-control input-xlarge" required="true">
                       		</div>
        </div>
		
        <div class="form-group row">
		<label class="col-lg-3 label">Zip or Postal code</label>
        <div class="col-lg-8">
                        <input id="postal-code" name="dCode" type="text" placeholder="zip or postal code" class="form-control input-xlarge" required="true">

		</div>
        </div>
        
        <div class="form-group row">
		<label class="col-lg-3 label">Country</label>
        <div class="col-lg-8">
        <select id="countryCode" name="aCon" class="form-control input-xlarge" required="True">
