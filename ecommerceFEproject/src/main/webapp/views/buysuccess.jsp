...
<div class="card bg-light text">
  <img class="card-img" src="<%=request.getContextPath()%>/images/success.jpg" style=" background-size: cover; background-position: center;  height: 700px; width=100%;" alt="Card image" />
  <div class="card-img-overlay">
    <p class="card-title  text-left" style="font-family: 'Montserrat', sans-serif; font-size: 50px"><i>Hi,<%=(String)session.getAttribute("dFname") %> <%=(String)session.getAttribute("dLname") %>Congratulation!</i></p>
    <hr>
    <p class="card-text" style="font-family: 'Montserrat', sans-serif; font-size: 40px"><i>Your order has been succesfully placed</i></p><hr>
    <p class="card-text" style="font-family: 'Montserrat', sans-serif; font-size: 40px"><i>YOUR FINAL BILL IS:<%=(String)session.getAttribute("Final_price")%> </i></p><hr>
        <p class="card-text" style="font-family: 'Montserrat', sans-serif; font-size: 40px"><i>Your order will be arrive in two to three days in your city <%=(String)session.getAttribute("dCity") %> </i></p><hr>

        <a href="${pageContext.request.contextPath}/" class="btn btn-primary btn-lg center-block" Style="background-color: red; color:black">Home Page</a>
	</div>
  </div>
</div>
