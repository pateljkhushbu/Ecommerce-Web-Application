...
<style>
body{
  background-image: url('<%=request.getContextPath()%>/images/night.jpg');
...
<h1>Sign Up</h1>
<form action="${pageContext.request.contextPath}/sign-up" method="post" oninput='cPass.setCustomValidity(p2.value != uPass.value ? "Passwords do not match." : "")'>
		<div class="form-group">
		<label for="user" class="label">Username</label>
		<input id="user" type="text" class="form-control" placeholder="Username" name="uName">
		</div>
		<div class="form-group">
		<label for="pass" class="label">Confirm Password</label>
		<input id="pass" type="password" class="form-control" data-type="password" placeholder="Minimum six characters" name="uPass">
		</div>
		<div class="form-group">
		<label for="pass" class="label">Password</label>
		<input id="pass" type="password" class="form-control" data-type="password" placeholder="Repeat password" name="cPass">
		</div>
		<div class="form-group">
		<label for="email" class="label">Email-id</label>
		<input id="email" type="email" class="form-control" placeholder="example@something.com" name="umail">
		</div>
		<div class="form-group">
		<input type="submit" class="form-control btn-primary" value="Sign Up"><br>
		<strong><a href="${pageContext.request.contextPath}/signinad">already have an account?login</a></strong>
	</div>
	</form>
	</div>
</div>
